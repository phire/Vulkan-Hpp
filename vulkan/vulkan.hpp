...
#  else
  ...
  public:
    ...
    VULKAN_HPP_CONSTEXPR Result error() const noexcept
    {
      return val;
    }
  ...
  public:
    ...
    VULKAN_HPP_CONSTEXPR ~Expected() VULKAN_HPP_NOEXCEPT
    {
      if ( has_val )
        val.~T();
    }
    ...
    VULKAN_HPP_CONSTEXPR const T * operator->() const VULKAN_HPP_NOEXCEPT
    {
      return &value();
    }

    VULKAN_HPP_CONSTEXPR_14 T * operator->() VULKAN_HPP_NOEXCEPT
    {
      return &value();
    }
